...
export default class Vector4 {
     ...
     * @returns Vector4 实例。
     */
    static ["##STRUCT_CONSTRUCTOR##"](): Vector4;
     ...
     */
    static add(value1: Vector4, value2: Vector4, result: Vector4): void;
    /**
     ...
     */
    static barycentric(value1: Vector4, value2: Vector4, value3: Vector4, amount1: number, amount2: number, result: Vector4): void;
    /**
     ...
     */
    static catmullRom(value1: Vector4, value2: Vector4, value3: Vector4, value4: Vector4, amount: number, result: Vector4): void;
    /**
     * 将值限制在指定范围内。
     * @param value1 要限制的值。
     * @param min 最小值。
     ...
     */
    static clamp(value1: Vector4, min: Vector4, max: Vector4, result: Vector4): void;
    /**
     * 计算两个矢量之间的距离。
     * @param value1 源矢量。
     * @param value2 源矢量。
     ...
     */
    static divide(value1: Vector4, divider: number, result: Vector4): void;
    /**
     * 用一个矢量的组件除以另一个矢量的组件。
     * @param value1 源矢量。
     * @param value2 除数矢量。
     ...
     * @param result [OutAttribute] 相除结果。
     */
    static divide(value1: Vector4, value2: Vector4, result: Vector4): void;
    /**
     * 计算两个矢量的点积。
     * @param vector1 源矢量。
     * @param vector2 源矢量。
     ...
     */
    static hermite(value1: Vector4, tangent1: Vector4, value2: Vector4, tangent2: Vector4, amount: number, result: Vector4): void;
    /**
     * 在两个矢量之间执行线性插值。
     * @param value1 源矢量。
     * @param value2 源矢量。
     ...
     */
    static lerp(value1: Vector4, value2: Vector4, amount: number, result: Vector4): void;
    /**
     ...
     */
    static max(value1: Vector4, value2: Vector4, result: Vector4): void;
    /**
     ...
     */
    static min(value1: Vector4, value2: Vector4, result: Vector4): void;
    /**
     * 将一个矢量乘以一个标量。
     * @param value1 源矢量。
     ...
     */
    static multiply(value1: Vector4, scaleFactor: number, result: Vector4): void;
    /**
     * 将两个矢量的组件彼此相乘。
     * @param value1 源矢量。
     * @param value2 源矢量。
     ...
     * @param result [OutAttribute] 相乘的结果。
     */
    static multiply(value1: Vector4, value2: Vector4, result: Vector4): void;
    /**
     * 返回指向反方向的矢量。
     * @param value 源矢量。
     * @returns 结果矢量。
     ...
     */
    static negate(value: Vector4, result: Vector4): void;
    /**
     * 根据指定的矢量创建单位矢量。
     ...
     */
    static normalize(vector: Vector4, result: Vector4): void;
    /**
     * 使用三次方程计算两个值之间的插值。
     * @param value1 源值。
     * @param value2 源值。
     ...
     */
    static smoothStep(value1: Vector4, value2: Vector4, amount: number, result: Vector4): void;
    /**
     * 将一个矢量减去一个矢量。
     * @param value1 源矢量。
     * @param value2 源矢量。
     ...
     */
    static subtract(value1: Vector4, value2: Vector4, result: Vector4): void;
    /**
     ...
     */
    static transform(position: Vector2, matrix: Matrix, result: Vector4): void;
    /**
     ...
     * @param result [OutAttribute] 通过变换得到的 Vector4。
     */
    static transform(value: Vector2, rotation: Quaternion, result: Vector4): void;
    /**
     ...
     * @param result [OutAttribute] 通过变换得到的 Vector4。
     */
    static transform(position: Vector3, matrix: Matrix, result: Vector4): void;
    /**
     ...
     * @param result [OutAttribute] 通过变换得到的 Vector4。
     */
    static transform(value: Vector3, rotation: Quaternion, result: Vector4): void;
    /**
     ...
     * @param result [OutAttribute] 通过变换得到的 Vector4。
     */
    static transform(vector: Vector4, matrix: Matrix, result: Vector4): void;
    /**
     ...
     * @param result [OutAttribute] 通过变换得到的 Vector4。
     */
    static transform(value: Vector4, rotation: Quaternion, result: Vector4): void;
    /**
     ...
     */
    static transform(sourceArray: List<Vector4>, sourceIndex: number, matrix: Matrix, destinationArray: List<Vector4>, destinationIndex: number, length: number): void;
    /**
     ...
     * @param length 要变换的 Vector4 数量。
     */
    static transform(sourceArray: List<Vector4>, sourceIndex: number, rotation: Quaternion, destinationArray: List<Vector4>, destinationIndex: number, length: number): void;
    /**
     ...
     */
    static transform(sourceArray: List<Vector4>, matrix: Matrix, destinationArray: List<Vector4>): void;
    /**
     ...
     * @param destinationArray 变换后的 Vector4 被写入的现有目标数组。
     */
    static transform(sourceArray: List<Vector4>, rotation: Quaternion, destinationArray: List<Vector4>): void;
    /**
     * 对传入的 Vector4 取反。
