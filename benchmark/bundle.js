...
(() => {
  ...
  var __decorateElement = (array, flags, name, decorators, target, extra) => {
    var fn, it, done, ctx, access, k2 = flags & 7, s = !!(flags & 8), p = !!(flags & 16);
    ...
    for (var i = decorators.length - 1; i >= 0; i--) {
      ...
      it = (0, decorators[i])(k2 ? k2 < 4 ? p ? extra : desc[key] : k2 > 4 ? void 0 : { get: desc.get, set: desc.set } : target, ctx), done._ = 1;
      if (k2 ^ 4 || it === void 0) __expectFn(it) && (k2 > 4 ? initializers.unshift(it) : k2 ? p ? extra = it : desc[key] = it : target = it);
  ...
  var BenchmarkSuite = class {
    ...
    async run(onProgress) {
      ...
      for (const test of this.tests) {
        ...
        const opsPerSecond = totalOps / (runEnd - runStart) * 1e3;
        const result = {
          suite: this.name,
          name: test.name,
          opsPerSecond
...
${c}`, c += a, new Error(c);
  ...
  // benchmark/suites/vector2.bench.ts
  suite("Vector2", (s) => {
    ...
    s.add("multiply (scalar)", () => {
      Vector2.multiply(v1, 2);
    });
    s.add("multiply (scalar) (result)", () => {
      Vector2.multiply(v1, 2, result);
    });
    s.add("dot", () => {
      Vector2.dot(v1, v2);
    });
  ...
  // benchmark/suites/vector3.bench.ts
  suite("Vector3", (s) => {
    ...
    s.add("multiply (scalar)", () => {
      Vector3.multiply(v1, 2);
    });
    s.add("multiply (scalar) (result)", () => {
      Vector3.multiply(v1, 2, result);
    });
    s.add("dot", () => {
      Vector3.dot(v1, v2);
    });
  ...
  // benchmark/suites/vector4.bench.ts
  suite("Vector4", (s) => {
    ...
    s.add("multiply (scalar)", () => {
      Vector4.multiply(v1, 2);
    });
    s.add("multiply (scalar) (result)", () => {
      Vector4.multiply(v1, 2, result);
    });
    s.add("dot", () => {
      Vector4.dot(v1, v2);
    });
  ...
  // benchmark/suites/matrix.bench.ts
  suite("Matrix", (s) => {
    ...
    s.add("createPerspectiveFieldOfView", () => {
      Matrix.createPerspectiveFieldOfView(Math.PI / 4, 1.33, 0.1, 1e3);
    });
    s.add("createPerspectiveFieldOfViewWithResult", () => {
      Matrix.createPerspectiveFieldOfView(Math.PI / 4, 1.33, 0.1, 1e3, result);
    });
    s.add("createWorld", () => {
    ...
    s.add("createOrthographic", () => {
      Matrix.createOrthographic(800, 600, 0.1, 1e3);
    });
    s.add("createOrthographicOffCenter", () => {
      Matrix.createOrthographicOffCenter(0, 800, 600, 0, 0.1, 1e3);
    });
    s.add("createPerspective", () => {
      Matrix.createPerspective(800, 600, 0.1, 1e3);
    });
    s.add("createPerspectiveOffCenter", () => {
      Matrix.createPerspectiveOffCenter(0, 800, 600, 0, 0.1, 1e3);
    });
  ...
  // benchmark/suites/quaternion.bench.ts
  suite("Quaternion", (s) => {
  ...
  // benchmark/suites/plane.bench.ts
  suite("Plane", (s) => {
  ...
  // benchmark/suites/bounding-box.bench.ts
  suite("BoundingBox", (s) => {
  ...
  // benchmark/suites/bounding-frustum.bench.ts
  ...
  // benchmark/suites/bounding-sphere.bench.ts
  ...
  // benchmark/suites/rectangle.bench.ts
  suite("Rectangle", (s) => {
  ...
  // benchmark/suites/point.bench.ts
  suite("Point", (s) => {
  ...
  var _y2_dec, _x2_dec, _y1_dec, _x1_dec, _dontCalc, _x1, _init13, _y1, _x22, _y22, _v1, _v2, _v3, _CubicBezier_instances, calc_fn;
  var _CubicBezier = class _CubicBezier {
    constructor(...params) {
      ...
      _CubicBezier[CONSTRUCTOR_SYMBOL13].apply(this, params);
    }
    /**
    ...
    static [(_x1_dec = [x2(Number)], _y1_dec = [x2(Number)], _x2_dec = [x2(Number)], _y2_dec = [x2(Number)], CONSTRUCTOR_SYMBOL13)](...params) {
      _CubicBezier[CONSTRUCTOR_SYMBOL13] = src_default().add([], function() {
        _CubicBezier[CONSTRUCTOR_SYMBOL13].call(this, 0, 0, 1, 1);
      }).add([Vector2, Vector2], function(p1, p2) {
        _CubicBezier[CONSTRUCTOR_SYMBOL13].call(this, p1.x, p1.y, p2.x, p2.y);
      ...
      return _CubicBezier[CONSTRUCTOR_SYMBOL13].apply(this, params);
    }
    ["=="](...params) {
  ...
  __decorateElement(_init13, 3, "x1", _x1_dec, _CubicBezier);
  __decorateElement(_init13, 3, "y1", _y1_dec, _CubicBezier);
  __decorateElement(_init13, 3, "x2", _x2_dec, _CubicBezier);
  __decorateElement(_init13, 3, "y2", _y2_dec, _CubicBezier);
  __decoratorMetadata(_init13, _CubicBezier);
  ...
  var _value_dec, _tangentOut_dec, _tangentIn_dec, _continuity_dec, _continuity, _init14, _tangentIn, _tangentOut, _value2, _position2;
  var _CurveKey = class _CurveKey {
    constructor(...params) {
      ...
      _CurveKey[CONSTRUCTOR_SYMBOL14].apply(this, params);
    }
    /**
    ...
    static [(_continuity_dec = [H(() => CurveContinuity)], _tangentIn_dec = [x2(Number)], _tangentOut_dec = [x2(Number)], _value_dec = [x2(Number)], CONSTRUCTOR_SYMBOL14)](...params) {
      _CurveKey[CONSTRUCTOR_SYMBOL14] = src_default().add([Number, Number], function(position, value) {
      ...
      return _CurveKey[CONSTRUCTOR_SYMBOL14].apply(this, params);
    }
    *[Symbol.iterator]() {
  ...
  __decorateElement(_init14, 3, "continuity", _continuity_dec, _CurveKey);
  __decorateElement(_init14, 3, "tangentIn", _tangentIn_dec, _CurveKey);
  __decorateElement(_init14, 3, "tangentOut", _tangentOut_dec, _CurveKey);
  __decorateElement(_init14, 3, "value", _value_dec, _CurveKey);
  __decoratorMetadata(_init14, _CurveKey);
  ...
  var _preLoop_dec, _postLoop_dec, _postLoop, _init15, _preLoop, _keys, _Curve_instances, getNumberOfCycle_fn, getCurvePosition_fn;
  var _Curve = class _Curve {
    constructor(...params) {
      ...
      _Curve[CONSTRUCTOR_SYMBOL15].apply(this, params);
    }
    /**
    ...
    static [(_postLoop_dec = [H(() => CurveLoopType)], _preLoop_dec = [H(() => CurveLoopType)], CONSTRUCTOR_SYMBOL15)](...params) {
      _Curve[CONSTRUCTOR_SYMBOL15] = src_default([], function() {
      ...
      return _Curve[CONSTRUCTOR_SYMBOL15].apply(this, params);
    }
    *[Symbol.iterator]() {
  ...
  __decorateElement(_init15, 3, "postLoop", _postLoop_dec, _Curve);
  __decorateElement(_init15, 3, "preLoop", _preLoop_dec, _Curve);
  __decoratorMetadata(_init15, _Curve);
  var Curve = _Curve;

  // benchmark/suites/math-helper.bench.ts
  suite("MathHelper", (s) => {
    s.add("barycentric", () => {
  ...
  // benchmark/suites/cubic-bezier.bench.ts
  suite("CubicBezier", (s) => {
    ...
    s.add("linear", () => {
      const b3 = CubicBezier.linear;
    });
    s.add("ease", () => {
      const b3 = CubicBezier.ease;
    });
    s.add("easeIn", () => {
      const b3 = CubicBezier.easeIn;
    });
    s.add("easeOut", () => {
      const b3 = CubicBezier.easeOut;
    });
    s.add("easeInOut", () => {
      const b3 = CubicBezier.easeInOut;
    });
    s.add("easeInSine", () => {
      const b3 = CubicBezier.easeInSine;
    });
    s.add("easeOutSine", () => {
      const b3 = CubicBezier.easeOutSine;
    });
    s.add("easeInOutSine", () => {
      const b3 = CubicBezier.easeInOutSine;
    });
    s.add("easeInQuad", () => {
      const b3 = CubicBezier.easeInQuad;
    });
    s.add("easeOutQuad", () => {
      const b3 = CubicBezier.easeOutQuad;
    });
    s.add("easeInOutQuad", () => {
      const b3 = CubicBezier.easeInOutQuad;
    });
    s.add("easeInCubic", () => {
      const b3 = CubicBezier.easeInCubic;
    });
    s.add("easeOutCubic", () => {
      const b3 = CubicBezier.easeOutCubic;
    });
    s.add("easeInOutCubic", () => {
      const b3 = CubicBezier.easeInOutCubic;
    });
    s.add("easeInQuart", () => {
      const b3 = CubicBezier.easeInQuart;
    });
    s.add("easeOutQuart", () => {
      const b3 = CubicBezier.easeOutQuart;
    });
    s.add("easeInOutQuart", () => {
      const b3 = CubicBezier.easeInOutQuart;
    });
    s.add("easeInQuint", () => {
      const b3 = CubicBezier.easeInQuint;
    });
    s.add("easeOutQuint", () => {
      const b3 = CubicBezier.easeOutQuint;
    });
    s.add("easeInOutQuint", () => {
      const b3 = CubicBezier.easeInOutQuint;
    });
    s.add("easeInExpo", () => {
      const b3 = CubicBezier.easeInExpo;
    });
    s.add("easeOutExpo", () => {
      const b3 = CubicBezier.easeOutExpo;
    });
    s.add("easeInOutExpo", () => {
      const b3 = CubicBezier.easeInOutExpo;
    });
    s.add("easeInCirc", () => {
      const b3 = CubicBezier.easeInCirc;
    });
    s.add("easeOutCirc", () => {
      const b3 = CubicBezier.easeOutCirc;
    });
    s.add("easeInOutCirc", () => {
      const b3 = CubicBezier.easeInOutCirc;
    });
    s.add("easeInBack", () => {
      const b3 = CubicBezier.easeInBack;
    });
    s.add("easeOutBack", () => {
      const b3 = CubicBezier.easeOutBack;
    });
    s.add("easeInOutBack", () => {
      const b3 = CubicBezier.easeInOutBack;
    });
    s.add("easeInElastic", () => {
      const b3 = CubicBezier.easeInElastic;
    });
    s.add("easeOutElastic", () => {
      const b3 = CubicBezier.easeOutElastic;
    });
    s.add("easeInOutElastic", () => {
      const b3 = CubicBezier.easeInOutElastic;
    });
    s.add("easeInBounce", () => {
      const b3 = CubicBezier.easeInBounce;
    });
    s.add("easeOutBounce", () => {
      const b3 = CubicBezier.easeOutBounce;
    });
    s.add("easeInOutBounce", () => {
      const b3 = CubicBezier.easeInOutBounce;
    });
    s.add("solve", () => {
      bezier.solve(0.5);
    });
  ...
  // benchmark/suites/curve.bench.ts
  suite("Curve", (s) => {
  ...
  // benchmark/suites/curve-key.bench.ts
  suite("CurveKey", (s) => {
  ...
  // benchmark/suites/curve-key-collection.bench.ts
